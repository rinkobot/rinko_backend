...
// Reuse shared types
pub use super::shared_types::{SatelliteDataBlock, AmsatReport, ReportStatus};
...
pub struct Transponder {
    ...
    pub amsat_api_name: Option<String>,
...
impl Transponder {
    ...
    pub fn new_basic(label: impl Into<String>, uplink: Frequency, downlink: Frequency) -> Self {
        Self {
            label: label.into(),
            uplink,
            downlink,
...
impl Satellite {
    ...
    pub fn get_amsat_api_names(&self) -> Vec<String> {
        ...
        for transponder in &self.transponders {
            if let Some(ref api_name) = transponder.amsat_api_name {
...
impl FrequencyCsvRow {
    ...
    pub fn to_transponder(&self) -> Transponder {
        ...
        Transponder {
            ...
            amsat_api_name: None, // Will be mapped later
